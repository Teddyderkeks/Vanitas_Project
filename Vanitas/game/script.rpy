...
label konversation:
    ...
    "Tycho" "Und es gibt definitiv auch keinen besseren Chef. Ich kenne niemanden, der sich so sehr um das Wohl der Menschheit sorgt und sich für alle einsetzt."
...
label plakate:
    ...
    a "{i}(Ich sollte mich nicht zu lange mit den Plakaten beschäftigen. Ich habe keine Lust Anan noch einmal über den Weg zu laufen und eine weitere Verwarnung zu riskieren.){/i}"
...
label treppenhausOhneMenu:
    ...
    a "{i}(Atropos, denk an die Pillen. Du solltest wirklich nicht mehr länger warten. Merkst du nicht, dass du nicht mehr perfekt glücklich bist?){/i}"
